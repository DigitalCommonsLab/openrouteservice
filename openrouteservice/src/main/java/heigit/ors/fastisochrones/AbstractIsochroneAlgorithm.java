...
import heigit.ors.routing.graphhopper.extensions.core.CoreDijkstraFilter;
...
//        additionalEdgeFilter.setInCore(false);
    ...
    public AbstractIsochroneAlgorithm setEdgeFilter(CoreDijkstraFilter additionalEdgeFilter) {
        this.additionalEdgeFilter = additionalEdgeFilter;
        return this;
    }
